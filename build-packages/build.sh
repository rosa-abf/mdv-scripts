...
echo "python $rpm_build_script_path/build-changelog.py -b 5 -h $commit_hash >> $spec_name"
python $rpm_build_script_path/build-changelog.py -b 5 -h $commit_hash >> $spec_name
