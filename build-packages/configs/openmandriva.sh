...
config_opts['urpmi_options'] = '--downloader wget --wget-options --auth-no-challenge --retry 5 --no-suggests --no-verify-rpm --ignoresize --ignorearch --excludedocs --downloader wget $extra_cfg_options'
